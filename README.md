...
&nbsp; `0, 0', 0'', 0''', ...`
Readers more versed with general purpose programming languages than with type theory might assume that 0 is
...
The set of possible values of `List[T]` is given by
