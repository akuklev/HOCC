...
фиксированного набора операций — индуктивные множества. В том числе сразу исключаются множества, допускающие бесконечные вправо цепочки a ∋ b ∋ c ∋ ···, чтобы не дай бог не напороться на паталогические автореферрентные множества.

Стандартная теория множеств ZF(C) рассматривает только индуктивные множества. В отличие от наивной теории множеств, в ZF(C) множества отождествляются с предикатами на множествах уже не точно. Всё ещё верно, что всякое множество S однозначно определяется предикатом `x ∈ S`, но не все предикаты представимы множествами. К тому же теряется философская красота аксиоматизации: стройный прицнип Фреге заменяется зоопарком разношерстных аксиом построения множеств.
...
теоретикомножественных моделей, в стандартной теории множеств или одном из её общепринятых расширений. Больше того, недавно<sup>[[Pa19](https://arxiv.org/abs/1907.00877)]</sup> удалось выделить минимальное ядро стандартной теории множеств H<sub><ω</sub> — уникальную теорию, доказывающую свою собственную непротиворечивость. В этой теории невозможно доказать существование бесконечного множества, благодаря чему она избегает теоремы Гёделя о том, что способные интерпретировать арифметику теории неспособны доказать собственную непротиворечивость. В то же время, добавляя к этому минимальному ядру постулат о существовании бесконечного множества, замкнутого относительно тех или иных наборов теоретикомножественных операций, мы получаем в точности ZF и её расширения, используемые для моделлирования других теорий. Автор прелполагает, что возможно определить конструктивистский аналог ядра H<sub><ω</sub> — индексированное ординалами семейство конструктивных теорий множеств CZF(ɑ) со следующими свойствами:
— В CZF(ɑ) постулируется существование всех ординалов < ɑ, но недоказуемо существование самого ɑ; таким образом proof theoretic strength |CZF(ɑ)| = ɑ;
— CZF(ɑ) содержит внутренние модели всех CZF(β) для β < ɑ и таким образом доказывает их непротиворечивость
— CZF(ω) доказывает те же факты про конечные множества, что и H<sub><ω</sub> и доказывает свою собственную непротиворечивость
— CZF(|CZF|) = CZF, где |CZF| = ω⌈ω⌈1⌉Ω⌉0 ординал Бахмана-Говарда

Такое семейство является идеальным инструментом измерения моделирующей силы аксиоматических теорий и других формальных систем.
