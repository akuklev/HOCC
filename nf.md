...
к чистой логике.
NF — чисто логическая система, в которой эмергентны натуральные числа и выводимы законы арифметики, т.н. постулаты Дедекинда-Пеано [[Tu12](https://cs.ioc.ee/~tarmo/tsem11/tupailo2401-slides.pdf)].
