...
предикатов можно обобщить до высше-категорного исчисления построений[[GWB24](https://arxiv.org/abs/2407.09146)] — языка, на котором описываются
не только логические утверждения, но ещё и доказательства и построения (такие, как, например геометрические построения и алгоритмы), причём с
учётом соответствий между ними. Исчисления построений представляют собой модельно-алгебраические теории, и таким образом допускают расширения,
описываемые в терминах образующих и тождеств. В случае исчислений построений, эти образующие это сигнатуры, а тождества — аксиомы описываемых
