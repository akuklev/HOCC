...
## Аксиоматическая теория предикатов (“Наивная теория множеств”)
...
Арифметика Пеано — аксиоматическая теория натуральных чисел. Может ли быть аксиоматическая теория, предметной областью
...
Напомним, что логический предикат это выразимое на языке данной теории утверждение φ[x] c параметром. Идея Фреге в том, чтобы
каждый логический предикат — элемент синтаксиса теории — представлялся объектом теории — элементом её семантики. Объекты теории —
“отражения предикатов” — по историческим причинам называются “множествами”. Сигнатура теории Фреге состоит из одного единственного
отношения — `x ∈ S` «множество x является элементом множества S». Будем говорить, что множество `S` представляет предикат φ[x],
если `x ∈ S ⇔ φ[x]`, то есть если множество S содержит в точности те же множества, для которых выполняется предикат `φ[x]`.
Фреге предлагает постулировать, что для каждого предиката существует представляющее его множество, однозначно определяемое предикатом.
Это бесконечное семейство постулатов вида `∃!(S) x ∈ S ⇔ φ[x]` — по одному для каждого выразимого на языке теории 
предиката φ[x]. Это семейство постулатов называется **принципом абстракции Фреге: всякое свойство, выразимое на языке данной теории, определяет, и притом однозначно, множество всех элементов, обладающих этим свойством**.

Итак, предлагаемая Фреге теория состоит из общих для всех аксиоматических теорий законов логики и принципа абстракции, позволяющего
рассматривать логические предикаты данной теории как её объекты. Её следовало бы назвать “исчислением предикатов с рефлексией” или
“аксиоматической теорией логических предикатов на самих себе”.
Но прижилось иное название — эту теорию и её фрагменты, в которых принцип абстракции выполняется с теми или иными ограничениями, 
называют (фундаментальными) теориями множеств.

## Понятие множества в основаниях математики
...
счётными, так и несчётными. Всё это — конкретные множества, совокупности каких-то наперёд определённых объектов без учёта
порядка и повторений.
...
множеств. Таким образом, фрегеанские множества это объектификация предикатов о самих себе. Эти множества — не множества
каких-то наперёд заданных объектов, а “множества сами по себе”.
Они напоминают конкретные множества тем, что их тоже можно рассматривать как “неупорядоченные наборы объектов без учёта
повторений”, но их элементы не какие-то объекты самостоятельной природы, а другие такие же множества.
...
Язык теории множеств позволяет описать «одноэлементность» как свойство — множество S одноэлементное, если существует
...
Согласно Фреге натуральное число n следует определять объектификацию свойства ‘n-элементности’, т.е. число n это множество
всех n-элементных множеств. Это не какое-то произвольное кодирование, а естественный способ мыслить о натуральных числах,
естественный способ концептуализации понятия натурального числа в терминах чистой логики.

Благодаря конструкции из первого абзаца мы знаем, что все натуральные числа суть непустые множества, и различные
натуральные числа не равны как множества, то есть определение состоятельно. Продолжая в том же духе, мы можем
также определить множество всех натуральных чисел, операции сложения и умножения на нём и
...
Выходит, можно полностью обосновать арифметику чистой логикой. Это стало отправной точкой и одновременно парадным результатом
логицизма — программы по обоснованию максимально широкого круга математических понятий чистой логикой.

Дальнейшие успехи логицизма были существенно скромнее — лишь редкие математические понятия можно столь же естественно понять
как множества. Да, логицизм блесяще работает для трансфинитных обобщений натуральных чисел, множеств натуральных чисел,
ряда понятий из области теоретико-множественной топологии и теории игр, но в большинстве случаев
естественного способа мыслить об объектах определённого типа, как о множествах, всё же нет.

Характерным примером является понятие упорядоченной пары. Уже из соображений симметрии видно, что не может существовать
...
## Совершенная общематематическая база
...
В процессе логицистского обоснования арифметики, Фреге понял, что его логическая система — идеальный кандидат на роль такой
...
В фундаментальную теорию множеств можно транслировать любые другие аксиоматические теории, в том же духе как компьютерные программы
...
строится общая база для всех разделов математики. Однако 16 июня 1902 Бертран Рассел письмо написал Готтлобу Фреге, который как раз
готовил к печати второй том монографии. “There is just one point where I have encountered a difficulty” — писал он:  
Принцип абстракции позволяет сконструировать множество {x | x ∉ x} всех множеств, не содержащих самих себя. Но если оно существует,
...
Философски-математический рай Фреге развалился как карточный домик и математика вошла в глубокий кризис оснований, радикально
...
типа {x | x ∉ x}. Начался поиск непротиворечивых фрагментов системы Фреге, которые бы годились для использования в качестве
...
Когда нужно что-то ограничить, всегда есть два крайних подхода — знаете, как с пищевыми добавками в США и в Европе.
В США разрешено всё кроме заведомо ядовитого. В ЕС запрещено всё, что не имеет доказанной безвредности.

Обжегшись на неограниченном принципе абстракции, математики начала XX века в основном пошли по второму пути:
стали рассматривать только множества, которые можно построить начиная с пустого множества “снизу вверх” при помощи
фиксированного набора операций — безопасные иерархические множества.

Стандартная теория множеств ZF(C) рассматривает только безопасные иерархические множества. Множества, допускающие
бесконечные вправо цепочки a ∋ b ∋ c ∋ ··· такими теориями не рассматриваются в принципе, чтобы не
дай бог не напороться на паталогические автореферрентные множества.

В отличие от фрегеанской теории множеств, в ZF(C) множества отождествляются с предикатами на множествах уже не точно:
не все предикаты представляются множествами. К тому же теряется философская красота аксиоматизации: стройный прицнип
абстракции заменяется на зоопарк разношерстных аксиом.
...
множеств, эта система состоит из логики предикатов с экстенциональным равенством и одним единственным семейством аксиом — принципом абстракции, но уже ограниченным синтаксически. Представимыми через множества постулируются не все предикаты, а лишь стратифицируемые. Стратифицируемость — некое синтаксической свойство формулы (не буду вдаваться в технические подробности), защищающее от паталогических автореферрентных множеств.
