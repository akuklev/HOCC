...
постулатов. Не считая общих для всех аксиоматических теорий законов логики, в ней постулируется один только принцип абстракции Фреге:  

| всякий логический предикат, т.е. выразимое на языке данной теории свойство, φ[x] определяет, и притом однозначно, множество всех элементов, обладающих этим свойством:<br>  `∃!(S) x ∈ S ⇔ φ[x]` |
|:-|

Этот принцип абстракции позволяет рассматривать логические предикаты данной теории как её объекты (“множества”), и её следовало
бы назвать “исчислением предикатов с рефлексией” или “аксиоматической теорией логических предикатов на самих себе”.
