...
предиката φ[x]. Это семейство постулатов называется **принципом абстракции Фреге: всякое выразимое на языке данной теории
свойство определяет, и притом однозначно, множество всех элементов, обладающих этим свойством**.
