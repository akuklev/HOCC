...
к чистой логике.
NF — чисто логическая система, в которой эмергентны натуральные числа и операции над ними, а их законы (постулаты Пеано) выводимы[[Tu12](https://cs.ioc.ee/~tarmo/tsem11/tupailo2401-slides.pdf)].
