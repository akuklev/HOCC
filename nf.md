...
[^1]: В своей 75-страничной монографии под ёмким названием Begriffsschrift («Концептопись: Формульный язык для строгого
мышления, созданный по образцу арифметических формул») Фреге описывает исчисление предикатов второго порядка и его фрагмент
— обыкновенное исчисление предикатов, о котором мы говорили выше.
...
Эта теория имеет особый, выделенный философский (эпистемологический) статус, т.к. в отличие от других аксиоматических теорий,
таких как геометрия Евклида или арифметика Пеано, она теория не аппелирует ни к какой внешней предметной области для обоснования
своих постулатов: не считая законов логики, в ней постулируется только принцип абстракции Фреге:  
  _всякое свойство определяет, и притом однозначно, множество всех элементов, обладающих этим свойством._
