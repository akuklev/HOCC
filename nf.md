...
- общей для всех теорий базы:
  ...
  - кванторов ‹существует такой х, что …› и ‹для любого х выполняется …›,
  - отношения равенства (=).
...
Не смотря на двухтысячелетнюю историю, первая исчерпывающая формализация исчисления предикатов была дана лишь в 1879 году
Готтлибом Фреге[^1].

[^1]: В своей 75-страничной монографии под ёмким названием Begriffsschrift («Концептопись: Формульный язык для строгого мышления, созданный по образцу арифметических формул») Фреге описывает исчисление предикатов второго порядка и его фрагмент — обыкновенное исчисление предикатов, о котором мы говорили выше.
...
которой является сами логические предикаты этой теории: исчисление предикатов с рефлексией.

Эта теория имеет особый эпистемический статус, т.к. в отличие от других аксиоматических теорий, таких как геометрия Евклида
или арифметика Пеано, она не аппелирует ни к какой внешней предметной области для обоснования своих постулатов: не считая
законов логики, в ней постулируется только принцип абстракции Фреге:  
  _всякое свойство определяет, и притом однозначно, множество всех элементов, обладающих этим свойством.[^2]_

[^2] Технически, принцип абстракции Фреге это не одна аксиома, а бесконечное семейство: для каждого предиката `φ[x]`,
определимого на языке логики предикатов, дополненной бинарным отношением принадлежности (∈), постулируется по аксоме вида `∃!(S) x ∈ S ⇔ φ[x]`.

В связи с использованием слова “множество”, эту логическую систему часто называют фрегеанской (или “наивной”) теорией множеств, однако
давайте сразу подчеркнём, что слово “множество“ используется тут не в обыденном, а в специальном смысле. Тут множества — объектификация
предикатов о самих же себе.

# Фрегеанское понятие множества

При первом знакомстве, множества обычно изображают как кружочки, содержащие буквы, цифры или точки. В формулировках задач и теорем
часто упоминают (в том числе бесконечные) множества чисел, множества точек, множества решений каких-нибудь уравнений. Пионер исследования
множеств Георг Кантор начал с исследования множеств вещественных чисел в контексте своих работ по тригонометрическим рядам; в 1872-1873 он
открыл, что бесконечные множества вещественных чисел могут быть как счётными, так и несчётными.

Всё это — множества каких-то наперёд определённых объектов, неупорядоченные наборы без повторений, один из распространённых типов материальных
стуктур наряду с упорядоченными наборами, неупорядоченными наборами с повторениями и т. д.

Так вот, у Фреге — не про них. Теории множеств изучают априорные множества, “множества сами по себе”. Они напоминают апостериорные 
множества тем, что их тоже можно рассматривать как “неупорядоченные наборы без повторений”, но их элементы не какие-то объекты самостоятельной
...
Выходит, что предмет рассмотрения теории множеств (всех теорий множеств, предназначенных для использования в качестве общематематической базы) — такие
