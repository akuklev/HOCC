...
Именно Готтлоб Фреге дал первую исчерпывающую формализацию исчисления предикатов<sup>[[Fr1879]([https://cs.ioc.ee/~tarmo/tsem11/tupailo2401-slides.pdf](https://rcin.org.pl/dlibra/publication/20448/edition/50430))]</sup>. 
...
которой является сами логические предикаты этой теории. Эта теория имеет особый эпистемический статус, т.к. в отличие от
других аксиоматических теорий, таких как геометрия Евклида или арифметика Пеано, она не аппелирует ни к какой внешней
предметной области для обоснования своих постулатов. Не считая (общих для всех аксиоматических теорий) законов логики,
в ней постулируется только принцип абстракции Фреге:  

| всякое свойство φ[x] определяет, и притом однозначно, множество всех элементов, обладающих этим свойством:<br>  `∃!(S) x ∈ S ⇔ φ[x]` |
|:-|

Принцип абстракции позволяет рассматривать логические предикаты данной теории как её объекты (“множества”), таким образом
её можно было бы назвать “исчислением предикатов с рефлексией”.
