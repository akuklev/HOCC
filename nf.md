...
Выходит, можно полностью обосновать арифметику чистой логикой. Это центральный результат логицизма — программы по обоснованию 
...
Как видно на примере последовательности множеств конечных размеров ∅, {∅}, {∅, {∅}}, {∅, {∅}, {∅, {∅}}}, ..., абстрактные
вложенные множества, сделанные out of thin air, из вакуума пустых множеств, являются богатым субстратом (“кирпичиками”) для
моделирования любых других математических объектов.

Возможность моделлировать сами натуральные числа и множества натуральных чисел открывает путь к моделированию практически любых
...
как компьютерные программы можно транслировать из высокоуровневых языков на низкоуровневый машинный язык. При трансляции теряется
различимость разнородных объектов (скажем, какое-нибудь вещественное число может случайно кодироваться тем же множеством, что и
какая-нибудь последовательность натуральных чисел) и нарушается принцип структурной эквивалентности (неразличимые объекты очень
часто транслируются в различные множества), но эти недостатки мало кого волновали на протяжении более чем века.

Множества — не единственный возможный субстрат для моделирования аксиоматических теорий (известной альтернативой является λ-исчисление),
логицизм делает выбор каноническим.
...
расширений. Больше того, недавно<sup>[[Pa19](https://arxiv.org/abs/1907.00877)]</sup> удалось выделить минимальное ядро стандартной теории множеств — уникальную теорию,
