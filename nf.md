...
бы назвать “исчислением предикатов с рефлексией”.
...
счётными, так и несчётными.

Всё это — конкретные множества, множества каких-то наперёд определённых объектов. Неупорядоченные наборы без повторений,
один из распространённых типов материальных стуктур наряду с упорядоченными наборами, неупорядоченными наборами с
повторениями и т. д.

В системе Фреге речь не о них. 

Фрегеанское понятие множества определяется принципом абстракции — множества это в
точности


“множество” в другом смысле. Его множества не множества каких-то наперёд заданных объектов, а
“множества сами по себе”. Они напоминают конкретные множества тем, что их тоже можно рассматривать
как “неупорядоченные наборы без повторений”, но их элементы не какие-то объекты самостоятельной природы, а другие такие
же множества.
