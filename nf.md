...
NF — чисто логическая система, в которой эмергентны натуральные числа и операции над ними, NF ⊢ PA (NF содержит арифметику Пеано),
см. [Specker’s Proof of Infinity in NF](https://cs.ioc.ee/~tarmo/tsem11/tupailo2401-slides.pdf). Кроме того, NF является
единственной известной логической системой, пригодной для рассуждения об всеобъемлющих автореферрентных структурах, таких как
