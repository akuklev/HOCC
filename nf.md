...
языка, на котором описываются не только логические утверждения, но ещё и доказательства и построения (такие, как, например геометрические построения,
алгебраические преобразования и алгоритмы), причём с учётом соответствий и связей между ними.

Исчисления построений представляют собой модельно-алгебраические теории, и таким образом допускают расширения,
