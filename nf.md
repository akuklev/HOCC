...
Обжегшись на неограниченном принципе абстракции, математики начала XX века в основном пошли по второму пути: xтобы не дай бог не напороться на паталогические автореферрентные множества, из рассмотрения намеренно исключаются множества, допускающие бесконечные вправо цепочки принадлежности x ∋ y ∋ z ∋ ···. Таким образом исключаются любые множества, прямо или опосредованно содержащие сами себя, в том числе
- множество всех множеств M ∋ M и
- одноэлементное содержащее само себя множество R = {R}. 

Таким образом остаются только только множества, которые можно построить начиная с пустого множества “снизу вверх” при помощи фиксированного набора операций — иерархические множества. Стандартная теория множеств ZF(C) рассматривает только иерархические множества. В отличие от наивной теории множеств, в ZF(C) множества отождествляются с предикатами на множествах уже не точно. Всё ещё верно, что всякое множество S однозначно определяется предикатом `x ∈ S`, но не все предикаты представимы множествами.

Этот подход оказался успешен и крайне продуктивен. В частности, состоятельность аксиоматических теорий неизменно доказывается путём построения
...
В теории Аккермана постулируется константа V — множество иерархических множеств (само по себе не являющееся иерархическим), а принцип абстракции разбивается на два аспекта — выделение и рефлексия.
